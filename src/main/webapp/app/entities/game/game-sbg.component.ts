...
@Component({
    selector: 'jhi-game-sbg',
    templateUrl: './game-sbg.component.html'
})
export class GameSbgComponent implements OnInit, OnDestroy {
...
currentAccount: any;
    ...
    transition() {
        this.router.navigate(['/game-sbg'], {queryParams:
            {
                page: this.page,
                size: this.itemsPerPage,
    ...
    trackId(index: number, item: GameSbg) {
        return item.id;
    }
